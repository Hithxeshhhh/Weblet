      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="text-gray-400">hello@weblet.com</li>
        ...
        <div className="pt-8 mt-8 border-t border-gray-800 flex flex-col md:flex-row items-center justify-between">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Weblet. All rights reserved.
          </p>
          ...
          <div className="mt-4 md:mt-0">
            <span className="text-gray-500 text-sm">Made with ❤️ by Weblet Team</span>
          </div>
        </div>
      </div>
    </footer>;
